...
window.onload = function () {
   ...
   function documentActions(e) {
      ...
      if (targetElement.closest('.daily__show')) {
         const dailyItem = document.querySelectorAll('.menu-daily__item');
         document.querySelector('.daily__text1').classList.toggle('_active');
         document.querySelector('.daily__text2').classList.toggle('_active');
         if (document.querySelector('.daily__text2').classList.contains('_active')) {
            for (let i = 0; i < dailyItem.length; i++) {
               if (!dailyItem[i].hasAttribute('vegan')) {
                  dailyItem[i].classList.add('_hide');
               }
            }
         }
         else {
            for (let i = 0; i < dailyItem.length; i++) {
               dailyItem[i].classList.remove('_hide');
            }
         }
         ...
         if (document.querySelector(".second-main")) {
            document.querySelector(".second-main").classList.add('_ibg');
         }
...
if (document.querySelector('.slider-daily__wrapper')) {
	new Swiper('.slider-daily__wrapper', {
		observer: true,
		observeParents: true,
		slidesPerView: 1,
		spaceBetween: 15,
		...
		navigation: {
			nextEl: '.arrows-slider .arrows-slider__arrow_next',
			prevEl: '.arrows-slider .arrows-slider__arrow_prev',
		},
		// breakpoints: {
		// 320: {
		// 	slidesPerView: 1,
